...
//    timer.tick();
    ...
    Point2f leftEyeCenter = findEyeCenterByColorSegmentation(cropped(leftEyeRect));
    Point2f rightEyeCenter; // = findEyeCenterByColorSegmentation(cropped(rightEyeRect));
