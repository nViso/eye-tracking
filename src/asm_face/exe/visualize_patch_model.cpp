...
int main(int argc,char** argv)
{
    //load data
    if(argc < 2){
        cout << "usage: ./visualise_patch_model host_dir (which contains the annotations.yaml)"
        << endl;
        return 0;
    }
    ...
    patch_models pmodel = load_ft<patch_models>(string(ftdata.baseDir+"patchmodels.yaml").c_str());
